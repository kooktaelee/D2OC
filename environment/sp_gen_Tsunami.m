...
offset_1 = [0,0];
offset_2 = [0,0];
Mu_gauss = {[32.82, 42.9], [31.84, 41.34], [29.46, 37.57], [27.58, 34.71], [26.02, 31.67], [24.71, 28.56], [23.48, 25.36], [24.63, 21.51], [26.76, 17.42], [26.51, 14.39], ...
            [27.35, 9.5], [29.15, 6.1], [21.1, 8.24], [20.94, 33.72], [21.02, 36.1], [21.19, 38.39], [8.9, 33.15], [9.31, 35.52], [10.21, 38.72], [9.47, 41.18]}; 
Sig_const = 2.5*eye(2);
...
Tot_no_sp = 200;
N_sp_gauss = round(Tot_no_sp*[0.1 0.15 0.2 0.25 0.3 0.3 0.3 0.25 0.20 0.15 ...
    0.10 0.05 0.1 0.15 0.2 0.25 0.3 0.3 0.3 0.25 0.20 ...
    0.15 0.15 0.10 0.05]); 
